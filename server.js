...
app.listen(PORT, async () => {
    ...
    try {
        ...
        `);
        console.log("💾 Table 'users' verified / initialized successfully inside the cloud!");
    } catch (err) {
        console.error("❌ Auto-table initialization failed:", err.message);
    }
});
